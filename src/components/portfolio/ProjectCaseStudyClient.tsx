...
export function ProjectCaseStudyClient({ slug }: { slug: string }) {
  const project = portfolio.projectsBySlug[slug as keyof typeof portfolio.projectsBySlug];
  const featured = portfolio.featuredProjects.find((item) => item.slug === slug);
